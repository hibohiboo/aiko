...
const MOBAMAS_CARDS: WikiPage[] = [
  ...
  { name: 'ほんわか花家', url: '/d/%a4%db%a4%f3%a4%ef%a4%ab%b2%d6%b2%c5', category: 'mobamas_card', order: 16 },
  { name: 'ぽかぽかエコロジー', url: '/d/%a4%dd%a4%ab%a4%dd%a4%ab%a5%a8%a5%b3%a5%ed%a5%b8%a1%bc', category: 'mobamas_card', order: 17 },
  { name: 'かさなる思い出', url: '/d/%a4%ab%a4%b5%a4%ca%a4%eb%bb%d7%a4%a4%bd%d5', category: 'mobamas_card', order: 18 },
  ...
  { name: '内緒の休息日', url: '/d/%c6%e2%bd%fb%a4%ce%b5%d9%c2%a9%c6%fc', category: 'mobamas_card', order: 23 },
...
const EVENT_STORIES: WikiPage[] = [
  ...
  { name: 'FlipFlop_第2話', url: '/d/%c2%e82%cf%c3%20%c7%f2%a4%a4%bd%a9%a4%ce%b7%c4%a4%df', category: 'event_story', subCategory: '03_flip_flop', order: 3 },
  { name: 'FlipFlop_第3話', url: '/d/%c2%e83%cf%c3%20%be%e5%a4%f2%b8%fe%a4%a3%a4%c6%c5%be%a4%dc%a4%a6', category: 'event_story', subCategory: '03_flip_flop', order: 4 },
  ...
  { name: 'スパイスパラダイス_第2話', url: '/d/%c2%e82%cf%c3%a1%a1%a4%ac%a4%c3%a4%c6%a4%ea%c6%c3%b7%b1%a1%f9turmeric', category: 'event_story', subCategory: '05_spice', order: 3 },
  { name: 'スパイスパラダイス_第3話', url: '/d/%c2%e83%cf%c3%a1%a1%a4%b8%a4%c3%a4%af%a4%ea%bd%fd%c0%ae%a1%f9red%20chili', category: 'event_story', subCategory: '05_spice', order: 4 },
